"""
Solana Copilot - Main FastAPI Application
...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    """
    # Startup
    logger.info("🚀 Starting Solana Copilot API Server...")
    ...
    # Shutdown
    logger.info("🛑 Shutting down Solana Copilot API Server...")
