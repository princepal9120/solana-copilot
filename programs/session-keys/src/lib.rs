...
declare_id!("SessioNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
...
pub mod session_keys {
    ...
    pub fn create_session_key(
        ...
        session_key.allowed_programs = allowed_programs;
    ...
    pub fn validate_session(
        ...
        require!(
            session_key.allowed_programs.contains(&program_id),
...
pub struct SessionKey {
    ...
    pub allowed_programs: Vec<Pubkey>,      // 4 + (32 * max_programs)
    pub is_active: bool,                    // 1
    pub bump: u8,                           // 1
}

impl SessionKey {
    // Assuming max 10 allowed programs
    pub const LEN: usize = 32 + 32 + 8 + 8 + 8 + 8 + 8 + 4 + (32 * 10) + 1 + 1;
}
